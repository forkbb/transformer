...
namespace ForkBB\Models\Transformer\Driver\FluxBB;
...
class FluxBB extends AbstractDriver
{
    ...
    public function groupsPre(DB $db, int $id): bool
    {
        ...
        unset($map['id_old'], $map['g_sig_length'], $map['g_sig_lines']);
    ...
    public function groupsGet(int &$id): ?array
    {
        ...
        return [
            ...
            'g_deledit_interval'     => (int) ($vars['g_deledit_interval'] ?? 0),
